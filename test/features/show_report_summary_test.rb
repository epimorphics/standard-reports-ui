...
feature "show the report summary" do
  scenario "visit the workflow step page" do
    visit report_design_path( {rt: :avgPrice, areaType: "country", aggregate: "none", period: "ytd", age: "any"} )
    ...
    %i{ rt areaType aggregate period age }.each do |param|
